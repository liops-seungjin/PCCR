...
(utils/rot_utils.py) — rotation presets + homogeneous matrix composition.
Only change: default rot_root_path is package-relative.
"""
...
_ROTATIONS_DIR = os.path.join(os.path.dirname(__file__), "rotations")


def load_rotations(rotation_choice, rot_root_path=_ROTATIONS_DIR):
    """
